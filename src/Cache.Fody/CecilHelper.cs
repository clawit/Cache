...
namespace Cache.Fody
{
    ...
    {
        internal static int AddVariable(this MethodDefinition method, TypeReference typeReference)
        {
        ...
        internal static Instruction Append(this Instruction instruction, Instruction instructionAfter, ILProcessor processor)
        {
        ...
        internal static Instruction AppendBoxIfNecessary(this Instruction instruction, ILProcessor processor,
        ...
        internal static Instruction AppendDup(this Instruction instruction, ILProcessor processor)
        {
            return instruction.Append(processor.Create(OpCodes.Dup), processor);
        }

        internal static Instruction AppendLd(this Instruction instruction, ILProcessor processor,
            CustomAttributeArgument argument, References references)
        {
            ...
            switch (argumentType.MetadataType)
            {
                case MetadataType.ValueType:
                    ...
                    {
                        throw new ArgumentException("Type Enum expected.", nameof(argument));
                    }
                    ...
                    for (int i = 0; i < values.Length; i++)
                    {
                        ...
                        if (arrayType.IsValueType)
                        {
                            switch (arrayType.MetadataType)
                            {
                                ...
                                default:
                                    throw new ArgumentException("Unrecognized array value type.", nameof(argument));
                            }
                        }
                        else
                        {
            ...
            switch (argumentType.MetadataType)
            {
                ...
                case MetadataType.Class:
                    ...
                    {
                        throw new ArgumentException("Type Type expected.", nameof(argument));
                    }
                ...
                default:
                    throw new ArgumentException("Unrecognized attribute parameter type.", nameof(argument));
            }
        }

        internal static Instruction AppendLdarg(this Instruction instruction, ILProcessor processor, int index)
        {
            return instruction.Append(processor.Create(OpCodes.Ldarg, index), processor);
        }

        internal static Instruction AppendLdcI4(this Instruction instruction, ILProcessor processor, int value)
        {
            return instruction.Append(processor.Create(OpCodes.Ldc_I4, value), processor);
        }

        internal static Instruction AppendLdloc(this Instruction instruction, ILProcessor processor, int index)
        {
            return instruction.Append(processor.Create(OpCodes.Ldloc, index), processor);
        }

        internal static Instruction AppendLdstr(this Instruction instruction, ILProcessor processor, string str)
        {
            return instruction.Append(processor.Create(OpCodes.Ldstr, str), processor);
        }

        internal static Instruction AppendStloc(this Instruction instruction, ILProcessor processor, int index)
        {
            return instruction.Append(processor.Create(OpCodes.Stloc, index), processor);
        }

        internal static bool ContainsAttribute(this ICustomAttributeProvider methodDefinition, TypeDefinition attributeType)
        {
            return methodDefinition.CustomAttributes.Any(x => x.Constructor.DeclaringType.FullName == attributeType.FullName);
        }

        internal static bool ContainsAttribute(this ICustomAttributeProvider methodDefinition, string attributeTypeName)
        {
            return methodDefinition.CustomAttributes.Any(x => x.Constructor.DeclaringType.Name == attributeTypeName);
        }

        internal static MethodDefinition GetInheritedPropertyGet(this TypeDefinition baseType, string propertyName)
        {
        ...
        internal static MethodDefinition GetMethod(this TypeDefinition typeDefinition, string methodName,
        ...
        internal static MethodDefinition GetPropertyGet(this TypeDefinition typeDefinition, string propertyName)
        {
            return typeDefinition.Properties.Where(x => x.Name == propertyName).Select(x => x.GetMethod).SingleOrDefault();
        }

        internal static MethodReference ImportMethod(this ModuleDefinition module, MethodDefinition methodDefinition)
        {
            return module.ImportMethod(methodDefinition);
        }

        internal static VariableDefinition ImportVariable(this ModuleDefinition module, TypeReference typeReference)
        {
            return new VariableDefinition(module.ImportReference(typeReference));
        }

        internal static bool IsEqualTo<T>(this IEnumerable<T> collection, IEnumerable<T> collectionToCompare)
        {
            int index = 0;
        ...
        internal static MethodReference MakeGeneric(this MethodReference method, params TypeReference[] arguments)
        {
        ...
        internal static MethodReference MakeHostInstanceGeneric(this MethodReference self, params TypeReference[] args)
        {
        ...
        internal static bool Matches(this MethodDefinition methodDefinition, string methodName, TypeReference returnType,
        ...
        internal static Instruction Prepend(this Instruction instruction, Instruction instructionBefore, ILProcessor processor)
        {
        ...
        internal static void RemoveAttribute(this ICustomAttributeProvider methodDefinition, string attributeTypeName)
        {
